...
public class Practica03Parte01JUnit {
	...
	public void test00() {
		...
		assertTrue(gestion.getNumPalabras("usuaria") == 5); 
		
		assertTrue(gestion.getPalabras("usuaria").size() == 2);
		assertEquals("[amor, hola]", gestion.getPalabras("usuaria").toString()); 		
		assertTrue(gestion.getFrecuencia("usuaria", "hola") == 3); 
		assertTrue(gestion.getFrecuencia("usuaria", "amor") == 2);
		...
		assertTrue(gestion.getFrecuencia("usuario", "leña") == 1);
	...
	public void test01() {
		...
		assertTrue(gestion.getNumPalabras("pEPe", "dispositivo03") == 34);
		...
		assertTrue(gestion.getPalabras("pepe", "dispositivo03").size() == 28);
		
		assertTrue(gestion.getPalabrasRepetidas("pepe").size() == 16); 
		
		assertTrue(gestion.getPalabras("pepa").size() == 396); 
		assertTrue(gestion.getPalabras("pepa", "dispositivo01").size() == 214);
		assertTrue(gestion.getPalabras("pepa", "dispositivo02").size() == 224); 
		
		assertTrue(gestion.getPalabrasRepetidas("pepa").size() == 42);
