...
import examenes.examenEnero2025.practica2.metodos_necesarios.Format;
import examenes.examenEnero2025.practica2.metodos_necesarios.MyMath;
import examenes.examenEnero2025.practica2.metodos_necesarios.Network;
	...
	public TreeMap<Asignatura, TreeMap<Asignatura, Integer>> getRelacionAsignaturas(){
	    ...
	    for (Entry<Asignatura, TreeSet<Estudiante>> entry1 : aux.entrySet()) {
	        ...
	        for (Entry<Asignatura, TreeSet<Estudiante>> entry2 : aux.entrySet()) {
	            ...
	            if (!interseccion.isEmpty()) relacionAsignatura.put(entry2.getKey(), interseccion.size());
	        }
