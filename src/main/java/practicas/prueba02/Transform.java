...
public class Transform {
	...
	/**
	 * Transformamos una estructura origen en una destino.
	 * Es crucial recorrer dicha estructura y asignarla
	 * a una estructura "copia/auxiliar/alternativa/...", 
	 * la cual meteremos en la estructura destino.
	 * Igual que los apuntes de clase.
	 */
	public void transform() {
		for (Entidad entidad : datosOrigen) {
			TreeSet<String> aux = new TreeSet<>();
			for (Entidad entidades : entidad) {
				aux.add(entidades.key);
			}
			datosDestino.put(entidad.key, aux);
		}
	}
